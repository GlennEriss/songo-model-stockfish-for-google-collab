...
cells = [
    ...
    code(
        ...
        BENCHMARK_MODEL_SEARCH_PROFILE = 'fort_plusplus'
        BENCHMARK_MODEL_SEARCH_DEPTH = 3
        BENCHMARK_MODEL_SEARCH_TOP_K = 6
        BENCHMARK_MODEL_SEARCH_TOP_K_CHILD = 4
        BENCHMARK_MODEL_SEARCH_ALPHA_BETA = True
        BENCHMARK_MODEL_SEARCH_POLICY_WEIGHT = 0.35
        BENCHMARK_MODEL_SEARCH_VALUE_WEIGHT = 1.0
        ...
        PROGRESSIVE_GLOBAL_MERGE_DATASET_ID = BASE_DATASET_BUILD_ID
        PROGRESSIVE_GLOBAL_MERGE_SOURCE_DATASET_ID_PREFIX = f'{BASE_DATASET_BUILD_ID}_'
        ...
        if LOW_QUOTA_PROFILE:
            ...
            PROGRESSIVE_GLOBAL_MERGE_EVERY_N_PARTIAL_EXPORTS = max(3, int(PROGRESSIVE_GLOBAL_MERGE_EVERY_N_PARTIAL_EXPORTS))
            PROGRESSIVE_GLOBAL_MERGE_MIN_INTERVAL_SECONDS = max(300.0, float(PROGRESSIVE_GLOBAL_MERGE_MIN_INTERVAL_SECONDS))
    ...
    code(
        ...
        STORAGE_CLEANUP_ENABLE_RETENTION_POLICY = True
        STORAGE_CLEANUP_RETENTION_JOB_STREAM_TTL_HOURS = 24.0
        ...
        def _build_retention_args():
            return [
                '--retention',
                '--retention-job-stream-ttl-hours',
                str(float(STORAGE_CLEANUP_RETENTION_JOB_STREAM_TTL_HOURS)),
                '--retention-quarantine-ttl-hours',
                str(float(STORAGE_CLEANUP_RETENTION_QUARANTINE_TTL_HOURS)),
                '--retention-source-metadata-raw-ttl-hours',
                str(float(STORAGE_CLEANUP_RETENTION_SOURCE_METADATA_TTL_HOURS)),
        ...
        def _print_safe_summary(report):
            ...
            retention = dict(steps.get('retention_cleanup', {}) or {})
            ...
            print(
                '  drive_root_operational_removed =',
                len(retention.get('drive_root_operational_artifacts_removed', []) or []),
            )
            print(
        ...
        if scope_value in {'safe_noncritical', 'full'}:
            ...
            if bool(STORAGE_CLEANUP_ENABLE_RETENTION_POLICY) and scope_value != 'full':
                safe_args.extend(_build_retention_args())
        ...
        if scope_value == 'full':
            ...
            if bool(STORAGE_CLEANUP_ENABLE_RETENTION_POLICY):
                full_args.extend(_build_retention_args())
    ...
    code(
        ...
        build_block['progressive_global_merge_enabled'] = bool(PROGRESSIVE_GLOBAL_MERGE_ENABLED)
        build_block['progressive_global_merge_dataset_id'] = str(PROGRESSIVE_GLOBAL_MERGE_DATASET_ID)
        build_block['progressive_global_merge_source_dataset_id_prefix'] = str(PROGRESSIVE_GLOBAL_MERGE_SOURCE_DATASET_ID_PREFIX)
        ...
        benchmark_block['model_search_enabled'] = True
        benchmark_block['model_search_profile'] = str(BENCHMARK_MODEL_SEARCH_PROFILE).strip().lower() or 'fort_plusplus'
        benchmark_block['model_search_depth'] = int(max(1, BENCHMARK_MODEL_SEARCH_DEPTH))
        benchmark_block['model_search_top_k'] = int(max(1, BENCHMARK_MODEL_SEARCH_TOP_K))
        benchmark_block['model_search_top_k_child'] = int(max(1, BENCHMARK_MODEL_SEARCH_TOP_K_CHILD))
        benchmark_block['model_search_alpha_beta'] = bool(BENCHMARK_MODEL_SEARCH_ALPHA_BETA)
        benchmark_block['model_search_policy_weight'] = float(BENCHMARK_MODEL_SEARCH_POLICY_WEIGHT)
        benchmark_block['model_search_value_weight'] = float(BENCHMARK_MODEL_SEARCH_VALUE_WEIGHT)
        ...
        print('BENCHMARK_MODEL_SEARCH_PROFILE =', BENCHMARK_MODEL_SEARCH_PROFILE)
        print('BENCHMARK_MODEL_SEARCH_DEPTH   =', BENCHMARK_MODEL_SEARCH_DEPTH)
        print('BENCHMARK_MODEL_SEARCH_TOP_K   =', BENCHMARK_MODEL_SEARCH_TOP_K)
        print('BENCHMARK_MODEL_SEARCH_TOP_K_CHILD =', BENCHMARK_MODEL_SEARCH_TOP_K_CHILD)
        print('BENCHMARK_MODEL_SEARCH_ALPHA_BETA =', BENCHMARK_MODEL_SEARCH_ALPHA_BETA)
        print('BENCHMARK_MODEL_SEARCH_POLICY_WEIGHT =', BENCHMARK_MODEL_SEARCH_POLICY_WEIGHT)
        print('BENCHMARK_MODEL_SEARCH_VALUE_WEIGHT =', BENCHMARK_MODEL_SEARCH_VALUE_WEIGHT)
        ...
        print('progressive_global_merge       =', build_block.get('progressive_global_merge_enabled'))
        print('progressive_global_dataset_id  =', build_block.get('progressive_global_merge_dataset_id'))
        print('progressive_global_source_pref =', build_block.get('progressive_global_merge_source_dataset_id_prefix'))
        print('progressive_global_every_n     =', build_block.get('progressive_global_merge_every_n_partial_exports'))
        print('progressive_global_min_interval_s =', build_block.get('progressive_global_merge_min_interval_seconds'))
    ...
    code(
        ...
        TOURNAMENT_MAX_PARALLEL_PAIRS = 16
        ...
        TOURNAMENT_AUTO_CAP_PARALLEL_BY_CPU = False
